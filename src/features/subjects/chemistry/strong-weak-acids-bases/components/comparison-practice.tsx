...
import { COMPARISON_QUESTIONS, type ComparisonQuestion } from "../model";

function QuestionCard({ item }: { item: ComparisonQuestion }) {
  ...
  return (
    <div className="rounded-card border border-line bg-white/60 p-4 dark:border-line-dark dark:bg-white/[0.03] sm:p-5">
      ...
      <p className="mt-1 font-mono text-sm text-ink-soft dark:text-bone-soft">{item.title}</p>
...
/** The spec's two comparison activities (HCl vs CH₃COOH, NaOH vs NH₃) — tiny, immediate feedback, no scoring. */
