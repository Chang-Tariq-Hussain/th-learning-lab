...
import { CHALLENGE_QUESTIONS } from "../calculus-model";

/**
 * Five fixed questions, one at a time, multiple-choice for reliable
 * immediate grading (no fuzzy text matching). Mirrors the "Check ->
 * feedback -> Next" rhythm every other math toy in this project uses.
 */
