...
import { CHALLENGE_QUESTIONS } from "../applications-model";

/** The four-question conceptual Mini Practice, same pattern as every other Calculus activity's mini challenge. */
export function MiniPracticePanel() {
