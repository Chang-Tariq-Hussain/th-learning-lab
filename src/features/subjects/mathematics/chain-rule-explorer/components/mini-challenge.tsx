...
import { CHALLENGE_QUESTIONS } from "../chain-rule-model";

/** The six-question mini practice, same pattern as Derivative Rules' `MiniChallenge`. */
    ...
    <div className="mx-auto flex w-full max-w-xl flex-col gap-5">
      ...
      {question.promptLatex ? (
        <div className="flex flex-col items-center gap-2">
          <BlockMath math={question.promptLatex} />
          <p className="text-center font-display text-base font-medium text-ink dark:text-bone">
            {question.prompt}
          </p>
        </div>
      ) : (
