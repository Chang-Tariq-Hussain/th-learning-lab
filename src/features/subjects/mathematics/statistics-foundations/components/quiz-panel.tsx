...
import type { ClassifyQuestion } from "../statistics-model";
...
/**
 * Generic multiple-choice quiz, same interaction pattern as Applications
 * of Derivatives' Mini Practice — select an option, get immediate
 * feedback and an explanation, move on. Reused for both Section 10
 * (Classify the Data) and Section 11 (Choose the Best Sampling Method)
 * since both are "read a prompt, pick from a short option list" games.
 */
export function QuizPanel({ questions, restartLabel = "Restart" }: QuizPanelProps) {
