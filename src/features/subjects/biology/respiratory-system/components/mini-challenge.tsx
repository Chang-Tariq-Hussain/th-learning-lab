...
import { CHALLENGE_QUESTIONS } from "../respiratory-model";
...
export function MiniChallenge({ step, feedback, onAnswer, onRestart }: MiniChallengeProps) {
    ...
    <div className="rounded-card border border-line bg-white/60 p-4 dark:border-line-dark dark:bg-white/[0.03]">
      ...
      {done ? (
        <p className="mt-2 text-sm font-medium text-pine-600 dark:text-pine-300">
          ✓ Nice work — you&apos;ve got breathing and gas exchange down.
        </p>
      ) : (
        <>
      ...
      {feedback !== null ? (
        <p className={cn("mt-3 text-sm font-medium", feedback ? "text-pine-600 dark:text-pine-300" : "text-red-600 dark:text-red-400")}>
