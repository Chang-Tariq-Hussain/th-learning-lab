...
/**
 * Physical board parts the 3D motherboard scene (`motherboard-parts.tsx`)
 * renders and lets students click, that don't correspond to one of the
 * architectural/logical `ComponentId`s above (registers, buses, cache,
 * control unit). `ram` and `storage` are physically placed on the board
 * too, but they're already covered by `ComponentId` and aren't repeated
 * here.
 */
export type PhysicalComponentId =
  | "motherboard"
  | "cpuSocket"
  | "cpu"
  | "chipset"
...
export const COMPONENTS: Record<ComponentId, ComponentDef> = {
  ...
  l2: {
    ...
    group: "Cache",
    description:
      "A mid-sized, mid-speed cache layer between L1 and L3. Larger and slower than L1, smaller and faster than L3.",
  },
  l1: {
    id: "l1",
    label: "L1 Cache",
  ...
  pc: {
    ...
    group: "CPU",
    description:
      "Holds the address of the next instruction to fetch. Advances automatically once the current instruction has been fetched.",
  },
  ir: {
    id: "ir",
    ...
    group: "CPU",
    description:
      "Holds the instruction currently being decoded and executed, once it's been fetched from memory/cache.",
  },
  controlUnit: {
    id: "controlUnit",
    label: "Control Unit",
  ...
  r1: {
    ...
    group: "CPU",
    description:
      "A small, extremely fast general-purpose storage slot inside the CPU, used to hold a value the ALU is actively working with.",
  },
  r2: {
    id: "r2",
    label: "Register R2",
    group: "CPU",
    description:
      "A second general-purpose register — same role as R1, holding another value the current instruction needs.",
  },
  alu: {
    id: "alu",
    ...
    group: "CPU",
    description:
      "The component that actually performs an instruction's calculation or comparison — addition here — once the Control Unit has decoded what to do.",
  },
};
...
export const INITIAL_REGISTERS: RegisterSnapshot = {
  pc: 1000,
  ir: null,
  r1: 0,
  r2: 3,
...
export const CACHE_LEVELS: CacheLevelDef[] = [
  ...
  },
  {
    ...
    name: "L2 Cache",
    relativeSize: "Medium",
    relativeSpeed: "Slower than L1",
  },
  {
    id: "l3",
    name: "L3 Cache",
    relativeSize: "Largest (of the three)",
    relativeSpeed: "Slower than L2, still far faster than RAM",
  },
];
...
export const INSTRUCTION_EXECUTIONS: InstructionExecution[] = [
      ...
      fetch: [
        {
          ...
          explanation:
            "The Program Counter holds address 1000 — the next instruction to fetch. That address goes out on the address bus.",
        },
        {
          id: "load-fetch-2",
          ...
          explanation:
            "The CPU checks its cache hierarchy first; assume this program was just loaded, so it isn't cached yet and the instruction comes from RAM.",
        },
        {
          id: "load-fetch-3",
          ...
          explanation:
            "The instruction arrives over the data bus and is placed in the Instruction Register. The Program Counter advances to 1001, ready for next time.",
        },
      ],
      decode: [
        {
          ...
          registers: { pc: 1001, ir: "LOAD R1, [1004]", r1: 0, r2: 3 },
          explanation:
            'The Control Unit reads the IR: operation "LOAD", destination register R1, source address 1004.',
        },
      ],
      execute: [
        {
          ...
          explanation:
            "The Control Unit requests address 1004 — address 1004 goes out on the address bus.",
        },
        {
          id: "load-execute-2",
          ...
          packetLabel: "5",
          explanation:
            "Not found in cache yet, so the value (5) is read from RAM. A copy is also kept in L1 in case it's needed again soon.",
        },
        {
          id: "load-execute-3",
          ...
          explanation:
            "The value 5 travels over the data bus into register R1. R1 now holds 5.",
        },
      ],
    },
  },
  {
    ...
    mnemonic: "ADD R1, R2",
    summary:
      "Adds register R2's value into register R1, replacing R1's old value with the sum.",
    steps: {
      fetch: [
        {
          id: "add-fetch-1",
          ...
          registers: { pc: 1001, ir: "LOAD R1, [1004]", r1: 5, r2: 3 },
          explanation:
            "The Program Counter now holds 1001 — the next instruction. That address goes out on the address bus.",
        },
        {
          id: "add-fetch-2",
          activeComponents: ["l1"],
          ...
          explanation:
            "This time the instruction is already sitting in L1 from earlier in the program — a cache hit, so it arrives almost immediately. The IR updates and the PC advances to 1002.",
        },
      ],
      decode: [
        {
          ...
          registers: { pc: 1002, ir: "ADD R1, R2", r1: 5, r2: 3 },
          explanation:
            'The Control Unit decodes: operation "ADD", operands R1 and R2, result goes back into R1.',
        },
      ],
      execute: [
        {
        ...
        },
        {
          ...
          explanation:
            "The ALU computes 5 + 3 = 8 and writes the result back into R1. R1 now holds 8; R2 is unchanged.",
        },
      ],
    },
  },
      ...
      fetch: [
        {
          ...
          registers: { pc: 1002, ir: "ADD R1, R2", r1: 8, r2: 3 },
          explanation:
            "Program Counter holds 1002. That address goes out on the address bus.",
        },
        {
          id: "store-fetch-2",
          ...
          explanation:
            "This instruction wasn't cached yet, so it's fetched from RAM into the IR. The Program Counter advances to 1003.",
        },
      ],
      decode: [
        {
          ...
          registers: { pc: 1003, ir: "STORE [1005], R1", r1: 8, r2: 3 },
          explanation:
            'The Control Unit decodes: operation "STORE", source register R1, destination address 1005 — a write, not a read.',
        },
      ],
      execute: [
        {
          ...
          explanation:
            'The Control Unit signals "write" on the control bus and puts destination address 1005 on the address bus.',
        },
        {
          id: "store-execute-2",
          activeComponents: ["r1", "dataBus"],
          ...
          explanation:
            "R1's value (8) travels out over the data bus toward RAM — the reverse direction from a read.",
        },
        {
          id: "store-execute-3",
...
export function buildMemoryAccessSteps(
  cell: MemoryCell,
  ...
  cold: [
    {
      ...
      activeComponents: ["l1"],
      explanation:
        "The CPU asks L1 Cache for address 2050. L1 doesn't have it — a miss.",
    },
    {
      id: "cold-2",
      activeComponents: ["l2"],
      explanation: "L2 Cache is checked next. Also a miss.",
    },
    {
      id: "cold-3",
      activeComponents: ["l3"],
      explanation:
        "L3 Cache is checked. Still a miss — this data has never been requested before.",
    },
    {
      id: "cold-4",
      ...
      explanation:
        "RAM has the data. It's returned to the CPU, and — because it was just used — a copy is kept in the cache levels so a future request can be answered faster.",
    },
  ],
  warm: [
    {
      ...
      packetLabel: "Data found",
      explanation:
        "The CPU asks L1 Cache for the same address again. This time it's already cached — a hit — so the data returns almost immediately, without ever going to RAM.",
    },
  ],
};
...
export const LOCALITY_NOTES = {
  temporal:
    "Temporal locality: data that was just used is likely to be used again soon — like this repeated request.",
  spatial:
    "Spatial locality: data stored near an address that was just used is also likely to be needed soon, so caches typically pull in a small neighborhood of nearby addresses, not just the exact one requested.",
};
...
export const BUS_WALKTHROUGHS: BusWalkthrough[] = [
  {
    ...
    title: "Address Bus",
    description:
      "Identifies which memory location is being accessed. Carries an address only — never the data stored there.",
    example: {
      id: "bus-address-example",
      activeComponents: ["controlUnit", "addressBus"],
      busSignal: { bus: "addressBus", value: "1004" },
      explanation:
        "The CPU wants the value at address 1004, so 1004 — and only 1004 — goes out on the address bus.",
    },
  },
  {
    bus: "dataBus",
    title: "Data Bus",
    description:
      "Carries the actual data or instruction being transferred — direction depends on whether it's a read (memory → CPU) or a write (CPU → memory).",
    example: {
      id: "bus-data-example",
      activeComponents: ["ram", "dataBus", "controlUnit"],
      from: "ram",
      ...
      busSignal: { bus: "dataBus", value: "5" },
      explanation:
        "In response to that address request, the value stored there (5) travels back over the data bus.",
    },
  },
  {
    bus: "controlBus",
    title: "Control Bus",
    description:
      'Carries coordination signals — read, write, and "ready" style signals that tell the other buses how to interpret what\'s on them.',
    example: {
      id: "bus-control-example",
      activeComponents: ["controlUnit", "controlBus"],
      busSignal: { bus: "controlBus", value: "READ" },
      explanation:
        'A "READ" signal on the control bus tells RAM this request is asking to retrieve data, not to overwrite it.',
    },
  },
];
...
export const FULL_SYSTEM_SCENARIO: FlowStep[] = [
  {
    ...
    explanation:
      "The program sits on persistent storage before it runs — three instructions and two data values, none of it in RAM yet.",
  },
  {
    id: "full-2",
    ...
    explanation:
      "The operating system loads the program's instructions and data from storage into RAM addresses 1000–1005, so the CPU can access them quickly.",
  },
  {
    id: "full-3",
    activeComponents: ["pc", "addressBus"],
    ...
    registers: { pc: 1000, ir: null, r1: 0, r2: 3 },
    explanation:
      "The Program Counter identifies address 1000 as the first instruction to fetch.",
  },
  {
    id: "full-4",
    activeComponents: ["l1", "l2", "l3", "ram"],
    ...
    packetLabel: "LOAD R1, [1004]",
    explanation:
      "The CPU checks its cache hierarchy first (L1 → L2 → L3); nothing is cached yet on a fresh run, so the instruction comes from RAM.",
  },
  {
    id: "full-5",
    activeComponents: ["ir", "dataBus"],
    ...
    registers: { pc: 1001, ir: "LOAD R1, [1004]", r1: 0, r2: 3 },
    explanation:
      "The instruction enters the Instruction Register. The Program Counter advances to 1001.",
  },
  {
    id: "full-6",
    activeComponents: ["ir", "controlUnit"],
    explanation:
      "The Control Unit decodes it: load the value at address 1004 into R1.",
  },
  {
    id: "full-7",
    ...
    registers: { pc: 1001, ir: "LOAD R1, [1004]", r1: 5, r2: 3 },
    explanation:
      "Address 1004's value (5) is retrieved and placed in register R1, with a copy kept in L1.",
  },
  {
    id: "full-8",
    ...
    registers: { pc: 1002, ir: "ADD R1, R2", r1: 5, r2: 3 },
    explanation:
      "Fetch repeats for address 1001 — this time it's a cache hit in L1, so it's noticeably quicker. The Control Unit decodes an ADD of R1 and R2.",
  },
  {
    id: "full-9",
    activeComponents: ["r1", "r2", "alu"],
  ...
  },
  {
    ...
    registers: { pc: 1002, ir: "ADD R1, R2", r1: 8, r2: 3 },
    explanation:
      "The ALU computes 8 and the result is written back into register R1.",
  },
  {
    id: "full-11",
    ...
    registers: { pc: 1003, ir: "STORE [1005], R1", r1: 8, r2: 3 },
    explanation:
      "The final instruction fetches from RAM (a miss this time), decodes as: write R1 to address 1005.",
  },
  {
    id: "full-12",
    ...
    busSignal: { bus: "dataBus", value: "8" },
    explanation:
      "R1's value (8) is written to RAM address 1005 — this updates working memory only, not storage yet.",
  },
  {
    id: "full-13",
    ...
    explanation:
      "If — and only if — the application later asks to save, that result in RAM is written out to persistent storage. Until that happens, it would be lost if the computer powered off.",
  },
  {
    id: "full-14",
    activeComponents: ["storage"],
    explanation:
      "The result now survives even after the program closes or the computer restarts — the distinction between RAM's working copy and storage's permanent copy.",
  },
];
...
export const MODES: ModeDef[] = [
  {
    ...
    shortLabel: "Overview",
    description:
      "The whole architecture at a glance, plus a 3D view of the physical layout.",
  },
  {
    id: "instruction",
    label: "Instruction Execution",
    shortLabel: "Execute",
    description: "Watch one instruction go through Fetch → Decode → Execute.",
  },
  {
    id: "memory",
    label: "Memory Access",
    shortLabel: "Memory",
    description:
      "Explore addressable memory and how the CPU reads and writes it.",
  },
  {
    id: "cache",
    label: "Cache",
    shortLabel: "Cache",
    description: "Run a cache hit and a cache miss and compare what happens.",
  },
  {
    id: "buses",
    label: "Bus Explorer",
    shortLabel: "Buses",
    description: "See what travels on the address, data, and control buses.",
  },
  {
    id: "full-system",
    label: "Full System Simulation",
    shortLabel: "Run a Program",
    description:
      "A complete guided run: storage → RAM → cache → registers → ALU → back to storage.",
  },
];
