...
export const themes: ThemeDefinition[] = [
  { id: "light", name: "Light", type: "light", previewFrom: "#F6F7F4", previewTo: "#142019" },
  { id: "soft-light", name: "Soft Light", type: "light", previewFrom: "#FAF6EF", previewTo: "#2B2620" },
  { id: "solarized-light", name: "Solarized Light", type: "light", previewFrom: "#FDF6E3", previewTo: "#586E75" },
  { id: "github-light", name: "GitHub Light", type: "light", previewFrom: "#FFFFFF", previewTo: "#1F2328" },
  { id: "dark", name: "Dark", type: "dark", previewFrom: "#0F1613", previewTo: "#E7ECE8" },
  { id: "midnight", name: "Midnight", type: "dark", previewFrom: "#05070D", previewTo: "#E3E8F5" },
  { id: "dracula", name: "Dracula", type: "dark", previewFrom: "#282A36", previewTo: "#F8F8F2" },
  { id: "nord", name: "Nord", type: "dark", previewFrom: "#2E3440", previewTo: "#ECEFF4" },
  { id: "monokai", name: "Monokai", type: "dark", previewFrom: "#272822", previewTo: "#F8F8F2" },
  { id: "one-dark", name: "One Dark", type: "dark", previewFrom: "#282C34", previewTo: "#ABB2BF" },
];
...
export function getThemeDefinition(id: string | undefined): ThemeDefinition | undefined {
