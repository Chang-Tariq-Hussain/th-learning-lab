...
const SIMULATION_HREF = "/dashboard/biology/dna-structure";
...
export default function DnaStructurePage() {
  const content = getTopicContent("biology", "dna-structure");
  ...
  return (
    <Container className="py-10">
      ...
      {content ? (
        <TopicExperience content={content} simulation={<DnaStructure />} />
      ) : (
