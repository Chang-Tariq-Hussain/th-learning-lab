...
const SIMULATION_HREF = "/dashboard/biology/food-chain-web";
...
export default function FoodChainWebPage() {
  const content = getTopicContent("biology", "food-chain-web");
    ...
    <Container className="py-10">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-xl text-sm text-ink-soft dark:text-bone-soft">
          Follow energy from the Sun through a grassland food chain, then switch to a food web to see how several
          food chains connect.
        </p>
      </div>

      {content ? (
        <TopicExperience content={content} simulation={<FoodChainWeb />} />
      ) : (
