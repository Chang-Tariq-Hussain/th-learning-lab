...
const SIMULATION_HREF = "/dashboard/biology/cell-membrane";

export const metadata: Metadata = {
  title: "Cell Membrane",
  description: "Selective permeability, and why a cell controls what crosses its boundary — explored with the Cell Membrane & Transport simulation.",
};

export default function CellMembranePage() {
  const content = getTopicContent("biology", "cell-membrane");
    ...
    <Container className="py-10">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 max-w-2xl text-base leading-relaxed text-ink-soft dark:text-bone-soft">
          Every cell controls what crosses its boundary. Learn what makes
          the membrane selectively permeable, then watch that control in
          action.
        </p>
      </div>
