...
const SIMULATION_HREF = "/dashboard/physics/magnet-explorer";
...
export default function MagnetExplorerPage() {
  const content = getTopicContent("physics", "magnet-explorer");
  ...
  return (
    <Container className="py-10">
      ...
      {content ? (
        <TopicExperience content={content} simulation={<MagnetExplorer />} />
      ) : (
