...
const SIMULATION_HREF = "/dashboard/physics/simple-motion";
...
export default function SimpleMotionPage() {
  const content = getTopicContent("physics", "simple-motion");
  ...
  return (
    <Container className="py-10">
      ...
      {content ? (
        <TopicLearningExperience content={content} simulation={<SimpleMotion />} />
      ) : (
