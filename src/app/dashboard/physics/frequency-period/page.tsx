...
const SIMULATION_HREF = "/dashboard/physics/frequency-period";
...
export default function FrequencyPeriodPage() {
  const content = getTopicContent("physics", "frequency-period");
  ...
  return (
    <Container className="py-10">
      ...
      {content ? (
        <TopicExperience content={content} simulation={<FrequencyPeriod />} />
      ) : (
        <FrequencyPeriod />
      )}
