...
const SIMULATION_HREF = "/dashboard/physics/basic-wave-motion";
...
export default function BasicWaveMotionPage() {
  const content = getTopicContent("physics", "basic-wave-motion");
  ...
  return (
    <Container className="py-10">
      ...
      {content ? (
        <TopicExperience content={content} simulation={<BasicWaveMotion />} />
      ) : (
