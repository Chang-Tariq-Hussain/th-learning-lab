...
const SIMULATION_HREF = "/dashboard/physics/wave-speed";
...
export default function WaveSpeedPage() {
  const content = getTopicContent("physics", "wave-speed");
  ...
  return (
    <Container className="py-10">
      ...
      {content ? (
        <TopicExperience content={content} simulation={<WaveSpeed />} />
      ) : (
        <WaveSpeed />
      )}
